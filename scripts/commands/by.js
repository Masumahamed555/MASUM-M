...
module.exports = {
  ...
  handleEvent: function({ api, event }) { // Removed unnecessary parameters
    ...
    if (["by","bye","By","Bye","good bye","Allah hafiz","allah hafiz",].some(keyword => lowerCaseBody.startsWith(keyword))) {
      const msg = {
        body: "আবার কথা হবে 🥰.\n\n~ যেকোনো তথ্যের জন্য আমার id তে নক দেন : Facebook https://www.facebook.com/profile.php?id=100078624862893&mibextid=ZbWKwL",
        attachment: fs.createReadStream(__dirname + `https://i.imgur.com/go4DEBc.jpeg`)
      };
